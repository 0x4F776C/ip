 ...
 * <p>Example usage:
 * <pre>
 * Event meeting = new Event("event eat churros at clarke quay before drinking at red bridge + club /from 8pm /to 10pm");
 * System.out.println(meeting); // Outputs: [E][] eat churros at clarke quay before drinking at red bridge + club (from: 8pm to: 10pm)
 * </pre>
 * </p>
 *
 * @see Task
...
public class Event extends Task {
     ...
     * and time details.
     *
     * @param input the raw input stirng in the format "event <description> /from <start> /to <end>"
     */
